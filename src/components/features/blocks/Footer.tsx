		...
		<footer className="bg-background text-foreground">
			<div className="container mx-auto px-5 py-12">
				<div className="flex flex-wrap md:text-left text-center order-first">
					...
					<div className="lg:w-1/4 md:w-1/2 w-full px-4">
						...
						<p className="text-muted-foreground text-sm mt-2 md:text-left text-center">Restez informé de nos dernières
			...
			<div className="bg-card">
				<div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
					<p className="text-muted-foreground text-sm text-center sm:text-left">© 2024 Merute Digital Orbital —
						<a href="https://twitter.com/merutedigital" rel="noopener noreferrer" className="text-primary ml-1"
							 target="_blank">@merutedigital</a>
					</p>
